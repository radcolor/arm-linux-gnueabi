...
enum opt_code
{
  ...
  OPT_Wanalyzer_use_of_uninitialized_value = 459,/* -Wanalyzer-use-of-uninitialized-value */
  ...
  OPT_Warray_compare = 466,                  /* -Warray-compare */
  ...
  OPT_Winterference_size = 601,              /* -Winterference-size */
  ...
  OPT_list = 1698,                           /* -list */
  OPT_mabi_ = 1699,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1700,             /* -mabort-on-noreturn */
  OPT_mandroid = 1701,                       /* -mandroid */
  OPT_mapcs = 1702,                          /* -mapcs */
  OPT_mapcs_frame = 1703,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1704,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1705,              /* -mapcs-stack-check */
  OPT_march_ = 1706,                         /* -march= */
  OPT_marm = 1707,                           /* -marm */
  OPT_masm_syntax_unified = 1708,            /* -masm-syntax-unified */
  OPT_mbe32 = 1709,                          /* -mbe32 */
  OPT_mbe8 = 1710,                           /* -mbe8 */
  OPT_mbig_endian = 1711,                    /* -mbig-endian */
  OPT_mbionic = 1712,                        /* -mbionic */
  OPT_mbranch_cost_ = 1713,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1714,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1715,     /* -mcaller-super-interworking */
  OPT_mcmse = 1716,                          /* -mcmse */
  OPT_mcpu_ = 1717,                          /* -mcpu= */
  OPT_mfdpic = 1718,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1719,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1720,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1721,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1722,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1723,                  /* -mfp16-format= */
  OPT_mfpu_ = 1724,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1725,             /* -mgeneral-regs-only */
  OPT_mglibc = 1726,                         /* -mglibc */
  /* OPT_mhard_float = 1727, */              /* -mhard-float */
  OPT_mlibarch_ = 1728,                      /* -mlibarch= */
  OPT_mlittle_endian = 1729,                 /* -mlittle-endian */
  OPT_mlong_calls = 1730,                    /* -mlong-calls */
  OPT_mmusl = 1731,                          /* -mmusl */
  OPT_mneon_for_64bits = 1732,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1733,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1734,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1735,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1736,               /* -mprint-tune-info */
  OPT_mpure_code = 1737,                     /* -mpure-code */
  OPT_mrestrict_it = 1738,                   /* -mrestrict-it */
  OPT_msched_prolog = 1739,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1740,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1741,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1742, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1743,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1744,                         /* -mthumb */
  OPT_mthumb_interwork = 1745,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1746,                  /* -mtls-dialect= */
  OPT_mtp_ = 1747,                           /* -mtp= */
  OPT_mtpcs_frame = 1748,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1749,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1750,                         /* -mtune= */
  OPT_muclibc = 1751,                        /* -muclibc */
  OPT_munaligned_access = 1752,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1753,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1754,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1755,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1756,              /* -mword-relocations */
  OPT_n = 1757,                              /* -n */
  OPT_name_sort = 1758,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1759,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1760,              /* -no-integrated-cpp */
  OPT_no_pie = 1761,                         /* -no-pie */
  OPT_nocpp = 1762,                          /* -nocpp */
  OPT_nodefaultlibs = 1763,                  /* -nodefaultlibs */
  OPT_nolibc = 1764,                         /* -nolibc */
  OPT_nophoboslib = 1765,                    /* -nophoboslib */
  OPT_nostartfiles = 1766,                   /* -nostartfiles */
  OPT_nostdinc = 1767,                       /* -nostdinc */
  OPT_nostdinc__ = 1768,                     /* -nostdinc++ */
  OPT_nostdlib = 1769,                       /* -nostdlib */
  OPT_o = 1770,                              /* -o */
  OPT_objects = 1771,                        /* -objects */
  OPT_p = 1772,                              /* -p */
  OPT_pass_exit_codes = 1773,                /* -pass-exit-codes */
  /* OPT_pedantic = 1774, */                 /* -pedantic */
  OPT_pedantic_errors = 1775,                /* -pedantic-errors */
  OPT_pg = 1776,                             /* -pg */
  OPT_pie = 1777,                            /* -pie */
  OPT_pipe = 1778,                           /* -pipe */
  OPT_posix = 1779,                          /* -posix */
  OPT_print_file_name_ = 1780,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1781,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1782,          /* -print-multi-directory */
  OPT_print_multi_lib = 1783,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1784,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1785,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1786,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1787,               /* -print-prog-name= */
  OPT_print_search_dirs = 1788,              /* -print-search-dirs */
  OPT_print_sysroot = 1789,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1790,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1791,                    /* -print-value */
  OPT_profile = 1792,                        /* -profile */
  OPT_pthread = 1793,                        /* -pthread */
  OPT_quiet = 1794,                          /* -quiet */
  OPT_r = 1795,                              /* -r */
  OPT_rdynamic = 1796,                       /* -rdynamic */
  OPT_remap = 1797,                          /* -remap */
  OPT_reverse_sort = 1798,                   /* -reverse-sort */
  OPT_s = 1799,                              /* -s */
  OPT_save_temps = 1800,                     /* -save-temps */
  OPT_save_temps_ = 1801,                    /* -save-temps= */
  OPT_shared = 1802,                         /* -shared */
  OPT_shared_libgcc = 1803,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1804,               /* -shared-libphobos */
  OPT_size_sort = 1805,                      /* -size-sort */
  /* OPT_specs = 1806, */                    /* -specs */
  OPT_specs_ = 1807,                         /* -specs= */
  OPT_static = 1808,                         /* -static */
  OPT_static_libasan = 1809,                 /* -static-libasan */
  OPT_static_libgcc = 1810,                  /* -static-libgcc */
  OPT_static_libgfortran = 1811,             /* -static-libgfortran */
  OPT_static_libgo = 1812,                   /* -static-libgo */
  OPT_static_libhwasan = 1813,               /* -static-libhwasan */
  OPT_static_liblsan = 1814,                 /* -static-liblsan */
  OPT_static_libmpx = 1815,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1816,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1817,               /* -static-libphobos */
  OPT_static_libstdc__ = 1818,               /* -static-libstdc++ */
  OPT_static_libtsan = 1819,                 /* -static-libtsan */
  OPT_static_libubsan = 1820,                /* -static-libubsan */
  OPT_static_pie = 1821,                     /* -static-pie */
  /* OPT_std_c__03 = 1822, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1823, */                /* -std=c++0x */
  OPT_std_c__11 = 1824,                      /* -std=c++11 */
  OPT_std_c__14 = 1825,                      /* -std=c++14 */
  OPT_std_c__17 = 1826,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1827, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1828, */                /* -std=c++1z */
  OPT_std_c__20 = 1829,                      /* -std=c++20 */
  OPT_std_c__23 = 1830,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1831, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1832, */                /* -std=c++2b */
  OPT_std_c__98 = 1833,                      /* -std=c++98 */
  OPT_std_c11 = 1834,                        /* -std=c11 */
  OPT_std_c17 = 1835,                        /* -std=c17 */
  /* OPT_std_c18 = 1836, */                  /* -std=c18 */
  /* OPT_std_c1x = 1837, */                  /* -std=c1x */
  OPT_std_c2x = 1838,                        /* -std=c2x */
  /* OPT_std_c89 = 1839, */                  /* -std=c89 */
  OPT_std_c90 = 1840,                        /* -std=c90 */
  OPT_std_c99 = 1841,                        /* -std=c99 */
  /* OPT_std_c9x = 1842, */                  /* -std=c9x */
  OPT_std_f2003 = 1843,                      /* -std=f2003 */
  OPT_std_f2008 = 1844,                      /* -std=f2008 */
  OPT_std_f2008ts = 1845,                    /* -std=f2008ts */
  OPT_std_f2018 = 1846,                      /* -std=f2018 */
  OPT_std_f95 = 1847,                        /* -std=f95 */
  OPT_std_gnu = 1848,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1849, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1850, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1851,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1852,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1853,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1854, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1855, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1856,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1857,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1858, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1859, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1860,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1861,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1862,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1863, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1864, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1865,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1866, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1867,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1868,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1869, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1870, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1871,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1872, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1873, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1874, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1875, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1876, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1877,                     /* -std=legacy */
  OPT_stdlib_ = 1878,                        /* -stdlib= */
  OPT_symbol_ = 1879,                        /* -symbol= */
  OPT_symbolic = 1880,                       /* -symbolic */
  OPT_t = 1881,                              /* -t */
  OPT_time = 1882,                           /* -time */
  OPT_time_ = 1883,                          /* -time= */
  OPT_tno_android_cc = 1884,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1885,                 /* -tno-android-ld */
  OPT_traditional = 1886,                    /* -traditional */
  OPT_traditional_cpp = 1887,                /* -traditional-cpp */
  OPT_tree_stats = 1888,                     /* -tree-stats */
  OPT_trigraphs = 1889,                      /* -trigraphs */
  OPT_type_stats = 1890,                     /* -type-stats */
  OPT_u = 1891,                              /* -u */
  OPT_undef = 1892,                          /* -undef */
  OPT_v = 1893,                              /* -v */
  OPT_version = 1894,                        /* -version */
  OPT_w = 1895,                              /* -w */
  OPT_wrapper = 1896,                        /* -wrapper */
  OPT_x = 1897,                              /* -x */
  OPT_z = 1898,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
