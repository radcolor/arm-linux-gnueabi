...
enum opt_code
{
  ...
  OPT_muclibc = 1726,                        /* -muclibc */
  OPT_munaligned_access = 1727,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1728,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1729,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1730,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1731,              /* -mword-relocations */
  OPT_n = 1732,                              /* -n */
  ...
  OPT_time = 1857,                           /* -time */
  OPT_time_ = 1858,                          /* -time= */
  OPT_tno_android_cc = 1859,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1860,                 /* -tno-android-ld */
