...
enum opt_code
{
  ...
  OPT_list = 1674,                           /* -list */
  OPT_mabi_ = 1675,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1676,             /* -mabort-on-noreturn */
  OPT_mandroid = 1677,                       /* -mandroid */
  ...
  OPT_mfix_cortex_m3_ldrd = 1695,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1696,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1697,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1698,                  /* -mfp16-format= */
  OPT_mfpu_ = 1699,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1700,             /* -mgeneral-regs-only */
  OPT_mglibc = 1701,                         /* -mglibc */
  /* OPT_mhard_float = 1702, */              /* -mhard-float */
  OPT_mlittle_endian = 1703,                 /* -mlittle-endian */
  OPT_mlong_calls = 1704,                    /* -mlong-calls */
  ...
  OPT_time = 1856,                           /* -time */
  OPT_time_ = 1857,                          /* -time= */
  OPT_tno_android_cc = 1858,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1859,                 /* -tno-android-ld */
  OPT_traditional = 1860,                    /* -traditional */
  OPT_traditional_cpp = 1861,                /* -traditional-cpp */
  OPT_tree_stats = 1862,                     /* -tree-stats */
  OPT_trigraphs = 1863,                      /* -trigraphs */
  OPT_type_stats = 1864,                     /* -type-stats */
  OPT_u = 1865,                              /* -u */
  OPT_undef = 1866,                          /* -undef */
  OPT_v = 1867,                              /* -v */
  OPT_version = 1868,                        /* -version */
  OPT_w = 1869,                              /* -w */
  OPT_wrapper = 1870,                        /* -wrapper */
  OPT_x = 1871,                              /* -x */
  OPT_z = 1872,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
