...
enum opt_code
{
  ...
  OPT_list = 1759,                           /* -list */
  OPT_mabi_ = 1760,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1761,             /* -mabort-on-noreturn */
  OPT_mandroid = 1762,                       /* -mandroid */
  OPT_mapcs = 1763,                          /* -mapcs */
  OPT_mapcs_frame = 1764,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1765,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1766,              /* -mapcs-stack-check */
  OPT_march_ = 1767,                         /* -march= */
  OPT_marm = 1768,                           /* -marm */
  OPT_masm_syntax_unified = 1769,            /* -masm-syntax-unified */
  OPT_mbe32 = 1770,                          /* -mbe32 */
  OPT_mbe8 = 1771,                           /* -mbe8 */
  OPT_mbig_endian = 1772,                    /* -mbig-endian */
  OPT_mbionic = 1773,                        /* -mbionic */
  OPT_mbranch_cost_ = 1774,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1775,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1776,     /* -mcaller-super-interworking */
  OPT_mcmse = 1777,                          /* -mcmse */
  OPT_mcpu_ = 1778,                          /* -mcpu= */
  OPT_mfdpic = 1779,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1780,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1781,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1782, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1783,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1784,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1785,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1786,                  /* -mfp16-format= */
  OPT_mfpu_ = 1787,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1788,             /* -mgeneral-regs-only */
  OPT_mglibc = 1789,                         /* -mglibc */
  /* OPT_mhard_float = 1790, */              /* -mhard-float */
  OPT_mlibarch_ = 1791,                      /* -mlibarch= */
  OPT_mlittle_endian = 1792,                 /* -mlittle-endian */
  OPT_mlong_calls = 1793,                    /* -mlong-calls */
  OPT_mmusl = 1794,                          /* -mmusl */
  ...
  OPT_profile = 1857,                        /* -profile */
  OPT_pthread = 1858,                        /* -pthread */
  OPT_quiet = 1859,                          /* -quiet */
  OPT_r = 1860,                              /* -r */
  OPT_rdynamic = 1861,                       /* -rdynamic */
  ...
  OPT_static_libstdc__ = 1883,               /* -static-libstdc++ */
  OPT_static_libtsan = 1884,                 /* -static-libtsan */
  OPT_static_libubsan = 1885,                /* -static-libubsan */
  OPT_static_pie = 1886,                     /* -static-pie */
  /* OPT_std_c__03 = 1887, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1888, */                /* -std=c++0x */
  OPT_std_c__11 = 1889,                      /* -std=c++11 */
  OPT_std_c__14 = 1890,                      /* -std=c++14 */
  OPT_std_c__17 = 1891,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1892, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1893, */                /* -std=c++1z */
  OPT_std_c__20 = 1894,                      /* -std=c++20 */
  OPT_std_c__23 = 1895,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1896, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1897, */                /* -std=c++2b */
  OPT_std_c__98 = 1898,                      /* -std=c++98 */
  OPT_std_c11 = 1899,                        /* -std=c11 */
  OPT_std_c17 = 1900,                        /* -std=c17 */
  /* OPT_std_c18 = 1901, */                  /* -std=c18 */
  /* OPT_std_c1x = 1902, */                  /* -std=c1x */
  OPT_std_c2x = 1903,                        /* -std=c2x */
  /* OPT_std_c89 = 1904, */                  /* -std=c89 */
  OPT_std_c90 = 1905,                        /* -std=c90 */
  OPT_std_c99 = 1906,                        /* -std=c99 */
  /* OPT_std_c9x = 1907, */                  /* -std=c9x */
  OPT_std_f2003 = 1908,                      /* -std=f2003 */
  OPT_std_f2008 = 1909,                      /* -std=f2008 */
  OPT_std_f2008ts = 1910,                    /* -std=f2008ts */
  OPT_std_f2018 = 1911,                      /* -std=f2018 */
  OPT_std_f95 = 1912,                        /* -std=f95 */
  OPT_std_gnu = 1913,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1914, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1915, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1916,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1917,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1918,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1919, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1920, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1921,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1922,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1923, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1924, */              /* -std=gnu++2b */
  ...
  OPT_stdlib_ = 1943,                        /* -stdlib= */
  OPT_symbol_ = 1944,                        /* -symbol= */
  OPT_symbolic = 1945,                       /* -symbolic */
  OPT_t = 1946,                              /* -t */
  OPT_time = 1947,                           /* -time */
  OPT_time_ = 1948,                          /* -time= */
  OPT_tno_android_cc = 1949,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1950,                 /* -tno-android-ld */
