...
enum opt_code
{
  ...
  OPT_list = 1760,                           /* -list */
  OPT_mabi_ = 1761,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1762,             /* -mabort-on-noreturn */
  OPT_mandroid = 1763,                       /* -mandroid */
  OPT_mapcs = 1764,                          /* -mapcs */
  OPT_mapcs_frame = 1765,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1766,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1767,              /* -mapcs-stack-check */
  OPT_march_ = 1768,                         /* -march= */
  OPT_marm = 1769,                           /* -marm */
  OPT_masm_syntax_unified = 1770,            /* -masm-syntax-unified */
  OPT_mbe32 = 1771,                          /* -mbe32 */
  OPT_mbe8 = 1772,                           /* -mbe8 */
  OPT_mbig_endian = 1773,                    /* -mbig-endian */
  OPT_mbionic = 1774,                        /* -mbionic */
  OPT_mbranch_cost_ = 1775,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1776,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1777,     /* -mcaller-super-interworking */
  OPT_mcmse = 1778,                          /* -mcmse */
  OPT_mcpu_ = 1779,                          /* -mcpu= */
  OPT_mfdpic = 1780,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1781,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1782,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1783, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1784,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1785,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1786,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1787,                  /* -mfp16-format= */
  OPT_mfpu_ = 1788,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1789,             /* -mgeneral-regs-only */
  OPT_mglibc = 1790,                         /* -mglibc */
  ...
  OPT_muclibc = 1817,                        /* -muclibc */
  OPT_munaligned_access = 1818,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1819,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1820,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1821,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1822,              /* -mword-relocations */
  OPT_n = 1823,                              /* -n */
  ...
  OPT_time = 1948,                           /* -time */
  OPT_time_ = 1949,                          /* -time= */
  OPT_tno_android_cc = 1950,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1951,                 /* -tno-android-ld */
