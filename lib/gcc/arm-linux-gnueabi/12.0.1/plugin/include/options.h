...
enum opt_code
{
  ...
  OPT_list = 1758,                           /* -list */
  OPT_mabi_ = 1759,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1760,             /* -mabort-on-noreturn */
  OPT_mandroid = 1761,                       /* -mandroid */
  OPT_mapcs = 1762,                          /* -mapcs */
  OPT_mapcs_frame = 1763,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1764,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1765,              /* -mapcs-stack-check */
  OPT_march_ = 1766,                         /* -march= */
  OPT_marm = 1767,                           /* -marm */
  OPT_masm_syntax_unified = 1768,            /* -masm-syntax-unified */
  OPT_mbe32 = 1769,                          /* -mbe32 */
  OPT_mbe8 = 1770,                           /* -mbe8 */
  OPT_mbig_endian = 1771,                    /* -mbig-endian */
  OPT_mbionic = 1772,                        /* -mbionic */
  OPT_mbranch_cost_ = 1773,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1774,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1775,     /* -mcaller-super-interworking */
  OPT_mcmse = 1776,                          /* -mcmse */
  OPT_mcpu_ = 1777,                          /* -mcpu= */
  OPT_mfdpic = 1778,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1779,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1780,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1781, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1782,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1783,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1784,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1785,                  /* -mfp16-format= */
  OPT_mfpu_ = 1786,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1787,             /* -mgeneral-regs-only */
  OPT_mglibc = 1788,                         /* -mglibc */
  /* OPT_mhard_float = 1789, */              /* -mhard-float */
  OPT_mlibarch_ = 1790,                      /* -mlibarch= */
  OPT_mlittle_endian = 1791,                 /* -mlittle-endian */
  OPT_mlong_calls = 1792,                    /* -mlong-calls */
  OPT_mmusl = 1793,                          /* -mmusl */
  OPT_mneon_for_64bits = 1794,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1795,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1796,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1797,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1798,               /* -mprint-tune-info */
  OPT_mpure_code = 1799,                     /* -mpure-code */
  OPT_mrestrict_it = 1800,                   /* -mrestrict-it */
  OPT_msched_prolog = 1801,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1802,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1803,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1804, */              /* -msoft-float */
  ...
  OPT_mstructure_size_boundary_ = 1807,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1808,                         /* -mthumb */
  OPT_mthumb_interwork = 1809,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1810,                  /* -mtls-dialect= */
  OPT_mtp_ = 1811,                           /* -mtp= */
  OPT_mtpcs_frame = 1812,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1813,               /* -mtpcs-leaf-frame */
  ...
  OPT_profile = 1856,                        /* -profile */
  OPT_pthread = 1857,                        /* -pthread */
  OPT_quiet = 1858,                          /* -quiet */
  OPT_r = 1859,                              /* -r */
  OPT_rdynamic = 1860,                       /* -rdynamic */
  ...
  OPT_static_libhwasan = 1877,               /* -static-libhwasan */
  OPT_static_liblsan = 1878,                 /* -static-liblsan */
  OPT_static_libmpx = 1879,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1880,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1881,               /* -static-libphobos */
  ...
  OPT_time = 1946,                           /* -time */
  OPT_time_ = 1947,                          /* -time= */
  OPT_tno_android_cc = 1948,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1949,                 /* -tno-android-ld */
