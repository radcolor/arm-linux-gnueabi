...
enum opt_code
{
  ...
  OPT_muclibc = 1645,                        /* -muclibc */
  OPT_munaligned_access = 1646,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1647,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1648,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1649,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1650,              /* -mword-relocations */
  OPT_n = 1651,                              /* -n */
  OPT_name_sort = 1652,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1653,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1654,              /* -no-integrated-cpp */
  OPT_no_pie = 1655,                         /* -no-pie */
  OPT_nocpp = 1656,                          /* -nocpp */
  OPT_nodefaultlibs = 1657,                  /* -nodefaultlibs */
  OPT_nolibc = 1658,                         /* -nolibc */
  OPT_nophoboslib = 1659,                    /* -nophoboslib */
  OPT_nostartfiles = 1660,                   /* -nostartfiles */
  OPT_nostdinc = 1661,                       /* -nostdinc */
  OPT_nostdinc__ = 1662,                     /* -nostdinc++ */
  OPT_nostdlib = 1663,                       /* -nostdlib */
  OPT_o = 1664,                              /* -o */
  OPT_objects = 1665,                        /* -objects */
  OPT_p = 1666,                              /* -p */
  OPT_pass_exit_codes = 1667,                /* -pass-exit-codes */
  /* OPT_pedantic = 1668, */                 /* -pedantic */
  OPT_pedantic_errors = 1669,                /* -pedantic-errors */
  OPT_pg = 1670,                             /* -pg */
  OPT_pie = 1671,                            /* -pie */
  OPT_pipe = 1672,                           /* -pipe */
  OPT_posix = 1673,                          /* -posix */
  OPT_print_file_name_ = 1674,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1675,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1676,          /* -print-multi-directory */
  OPT_print_multi_lib = 1677,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1678,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1679,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1680,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1681,               /* -print-prog-name= */
  OPT_print_search_dirs = 1682,              /* -print-search-dirs */
  OPT_print_sysroot = 1683,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1684,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1685,                    /* -print-value */
  OPT_profile = 1686,                        /* -profile */
  OPT_pthread = 1687,                        /* -pthread */
  OPT_quiet = 1688,                          /* -quiet */
  OPT_r = 1689,                              /* -r */
  OPT_rdynamic = 1690,                       /* -rdynamic */
  ...
  OPT_time = 1770,                           /* -time */
  OPT_time_ = 1771,                          /* -time= */
  OPT_tno_android_cc = 1772,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1773,                 /* -tno-android-ld */
