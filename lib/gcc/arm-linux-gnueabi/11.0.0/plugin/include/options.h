...
enum opt_code
{
  ...
  OPT_Wpessimizing_move = 629,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 630, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 631,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 632,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 633,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 634,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 635,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 636,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 637,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 638,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 639,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 640,                       /* -Wprotocol */
  OPT_Wpsabi = 641,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 642,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 643,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 644,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 645,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 646,                /* -Wredundant-decls */
  OPT_Wredundant_move = 647,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 648,                 /* -Wredundant-tags */
  OPT_Wregister = 649,                       /* -Wregister */
  OPT_Wreorder = 650,                        /* -Wreorder */
  OPT_Wrestrict = 651,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 652,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 653,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 654,           /* -Wscalar-storage-order */
  OPT_Wselector = 655,                       /* -Wselector */
  OPT_Wsequence_point = 656,                 /* -Wsequence-point */
  OPT_Wshadow = 657,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 658, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 659,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 660, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 661,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 662, */            /* -Wshadow=global */
  OPT_Wshadow_local = 663,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 664,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 665,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 666,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 667, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 668,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 669,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 670,                /* -Wsign-conversion */
  OPT_Wsign_promo = 671,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 672,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 673,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 674,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 675,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 676,                    /* -Wspeculative */
  OPT_Wstack_protector = 677,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 678,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 679,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 680,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 681,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 682,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 683,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 684,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 685,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 686,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 687, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 688,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 689,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 690,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 691,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 692,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 693,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 694,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 695,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 696,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 697,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 698,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 699,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 700,               /* -Wsuggest-override */
  OPT_Wsurprising = 701,                     /* -Wsurprising */
  OPT_Wswitch = 702,                         /* -Wswitch */
  OPT_Wswitch_bool = 703,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 704,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 705,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 706,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 707,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 708,                      /* -Wsync-nand */
  OPT_Wsynth = 709,                          /* -Wsynth */
  OPT_Wsystem_headers = 710,                 /* -Wsystem-headers */
  OPT_Wtabs = 711,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 712,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 713,           /* -Wtautological-compare */
  OPT_Wtemplates = 714,                      /* -Wtemplates */
  OPT_Wterminate = 715,                      /* -Wterminate */
  OPT_Wtraditional = 716,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 717,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 718,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 719,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 720,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 721,            /* -Wundeclared-selector */
  OPT_Wundef = 722,                          /* -Wundef */
  OPT_Wundefined_do_loop = 723,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 724,                      /* -Wunderflow */
  OPT_Wuninitialized = 725,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 726,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 727, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 728, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 729,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 730,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 731,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 732,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 733, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 734,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 735,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 736,                /* -Wunused-function */
  OPT_Wunused_label = 737,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 738,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 739,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 740,               /* -Wunused-parameter */
  OPT_Wunused_result = 741,                  /* -Wunused-result */
  OPT_Wunused_value = 742,                   /* -Wunused-value */
  OPT_Wunused_variable = 743,                /* -Wunused-variable */
  OPT_Wuse_without_only = 744,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 745,                   /* -Wuseless-cast */
  OPT_Wvarargs = 746,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 747,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 748,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 749,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 750,            /* -Wvirtual-move-assign */
  OPT_Wvla = 751,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 752,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 753,                  /* -Wvla-parameter */
  OPT_Wvolatile = 754,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 755,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 756,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 757,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 758,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 759,                       /* -Wzerotrip */
  OPT_X = 760,                               /* -X */
  OPT_Xassembler = 761,                      /* -Xassembler */
  OPT_Xf = 762,                              /* -Xf */
  OPT_Xlinker = 763,                         /* -Xlinker */
  OPT_Xpreprocessor = 764,                   /* -Xpreprocessor */
  OPT_Z = 765,                               /* -Z */
  OPT_ansi = 766,                            /* -ansi */
  OPT_aux_info = 767,                        /* -aux-info */
  /* OPT_aux_info_ = 768, */                 /* -aux-info= */
  OPT_c = 769,                               /* -c */
  OPT_callgraph = 770,                       /* -callgraph */
  OPT_coverage = 771,                        /* -coverage */
  OPT_cpp = 772,                             /* -cpp */
  OPT_cpp_ = 773,                            /* -cpp= */
  OPT_d = 774,                               /* -d */
  OPT_debuglib_ = 775,                       /* -debuglib= */
  OPT_defaultlib_ = 776,                     /* -defaultlib= */
  OPT_defined_only = 777,                    /* -defined-only */
  OPT_demangle = 778,                        /* -demangle */
  OPT_dstartfiles = 779,                     /* -dstartfiles */
  OPT_dump_body_ = 780,                      /* -dump-body= */
  OPT_dump_level_ = 781,                     /* -dump-level= */
  OPT_dumpbase = 782,                        /* -dumpbase */
  OPT_dumpbase_ext = 783,                    /* -dumpbase-ext */
  OPT_dumpdir = 784,                         /* -dumpdir */
  OPT_dumpfullversion = 785,                 /* -dumpfullversion */
  OPT_dumpmachine = 786,                     /* -dumpmachine */
  OPT_dumpspecs = 787,                       /* -dumpspecs */
  OPT_dumpversion = 788,                     /* -dumpversion */
  OPT_e = 789,                               /* -e */
  OPT_export_dynamic = 790,                  /* -export-dynamic */
  OPT_fPIC = 791,                            /* -fPIC */
  OPT_fPIE = 792,                            /* -fPIE */
  OPT_fRTS_ = 793,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 794,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 795,                   /* -fabi-version= */
  OPT_faccess_control = 796,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 797,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 798,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 799,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 800,                  /* -falign-commons */
  OPT_falign_functions = 801,                /* -falign-functions */
  OPT_falign_functions_ = 802,               /* -falign-functions= */
  OPT_falign_jumps = 803,                    /* -falign-jumps */
  OPT_falign_jumps_ = 804,                   /* -falign-jumps= */
  OPT_falign_labels = 805,                   /* -falign-labels */
  OPT_falign_labels_ = 806,                  /* -falign-labels= */
  OPT_falign_loops = 807,                    /* -falign-loops */
  OPT_falign_loops_ = 808,                   /* -falign-loops= */
  /* OPT_faligned_new = 809, */              /* -faligned-new */
  OPT_faligned_new_ = 810,                   /* -faligned-new= */
  OPT_fall_instantiations = 811,             /* -fall-instantiations */
  OPT_fall_intrinsics = 812,                 /* -fall-intrinsics */
  OPT_fall_virtual = 813,                    /* -fall-virtual */
  OPT_fallocation_dce = 814,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 815,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 816,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 817,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 818,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 819,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 820,         /* -falt-external-templates */
  OPT_fanalyzer = 821,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 822,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 823,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 824,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 825,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 826,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 827,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 828,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 829,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 830,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 831, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 832,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 833, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 834, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 835, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 836, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 837,            /* -fasan-shadow-offset= */
  OPT_fasm = 838,                            /* -fasm */
  OPT_fassert = 839,                         /* -fassert */
  OPT_fassociative_math = 840,               /* -fassociative-math */
  OPT_fassume_phsa = 841,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 842,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 843,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 844,                   /* -fauto-profile */
  OPT_fauto_profile_ = 845,                  /* -fauto-profile= */
  OPT_fautomatic = 846,                      /* -fautomatic */
  OPT_fbackslash = 847,                      /* -fbackslash */
  OPT_fbacktrace = 848,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 849,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 850,                   /* -fbounds-check */
  OPT_fbounds_check_ = 851,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 852,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 853,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 854, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 855, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 856, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 857,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 858,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 859,                        /* -fbuiltin */
  OPT_fbuiltin_ = 860,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 861,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 862,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 863,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 864,                    /* -fcall-saved- */
  OPT_fcall_used_ = 865,                     /* -fcall-used- */
  OPT_fcaller_saves = 866,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 867,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 868,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 869,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 870, */            /* -fcf-protection */
  OPT_fcf_protection_ = 871,                 /* -fcf-protection= */
  OPT_fchar8_t = 872,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 873,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 874, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 875,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 876,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 877,                         /* -fcheck= */
  OPT_fchecking = 878,                       /* -fchecking */
  OPT_fchecking_ = 879,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 880,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 881,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 882,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 883,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 884,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 885,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 886,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 887,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 888, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 889,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 890,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 891,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 892, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 893,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 894,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 895,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 896,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 897,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 898, */                 /* -fcilkplus */
  OPT_fcoarray_ = 899,                       /* -fcoarray= */
  OPT_fcode_hoisting = 900,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 901,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 902,                         /* -fcommon */
  OPT_fcompare_debug = 903,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 904,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 905,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 906,                   /* -fcompare-elim */
  OPT_fconcepts = 907,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 908,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 909,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 910,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 911, */           /* -fconserve-space */
  OPT_fconserve_stack = 912,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 913,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 914,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 915,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 916,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 917,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 918,                       /* -fconvert= */
  OPT_fcoroutines = 919,                     /* -fcoroutines */
  OPT_fcprop_registers = 920,                /* -fcprop-registers */
  OPT_fcray_pointer = 921,                   /* -fcray-pointer */
  OPT_fcrossjumping = 922,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 923,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 924, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 925,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 926,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 927,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 928,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 929,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 930,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 931,                       /* -fdbg-cnt= */
  OPT_fdce = 932,                            /* -fdce */
  OPT_fdebug = 933,                          /* -fdebug */
  OPT_fdebug_cpp = 934,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 935,              /* -fdebug-prefix-map= */
  ...
  OPT_fdiagnostics_column_origin_ = 964,     /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 965,       /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_format_ = 966,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 967,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 968,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 969,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 970,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 971,       /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 972,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 973,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 974,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 975,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 976,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 977,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 978,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 979, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 980,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 981,                /* -fdirectives-only */
  OPT_fdisable_ = 982,                       /* -fdisable- */
  OPT_fdoc = 983,                            /* -fdoc */
  OPT_fdoc_dir_ = 984,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 985,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 986,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 987,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 988,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 989,                       /* -fdruntime */
  OPT_fdse = 990,                            /* -fdse */
  OPT_fdump_ = 991,                          /* -fdump- */
  OPT_fdump_ada_spec = 992,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 993,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 994,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 995,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 996,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 997,   /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 998, /* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 999, /* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_json = 1000,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1001,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1002,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1003,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1004, */               /* -fdump-core */
  OPT_fdump_d_original = 1005,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1006,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1007,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1008,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1009,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1010,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1011,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1012,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1013,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1014, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1015,                   /* -fdump-passes */
  OPT_fdump_scos = 1016,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1017,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1018,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1019,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1020,                /* -fearly-inlining */
  OPT_felide_constructors = 1021,            /* -felide-constructors */
  OPT_felide_type = 1022,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1023, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1024,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1025,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1026,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1027,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1028,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1029,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1030,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1031,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1032,                /* -fenum-int-equiv */
  OPT_fexceptions = 1033,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1034,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1035,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1036,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1037,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1038,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1039,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1040,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1041,            /* -fexternal-templates */
  OPT_ff2c = 1042,                           /* -ff2c */
  OPT_ffast_math = 1043,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1044,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1045,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1046,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1047,              /* -ffinite-math-only */
  OPT_ffixed_ = 1048,                        /* -ffixed- */
  OPT_ffixed_form = 1049,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1050,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1051,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1052,                   /* -ffloat-store */
  ...
  OPT_fipa_modref = 1145,                    /* -fipa-modref */
  ...
  OPT_flarge_source_files = 1174,            /* -flarge-source-files */
  ...
  /* OPT_floop_block = 1185, */              /* -floop-block */
  /* OPT_floop_flatten = 1186, */            /* -floop-flatten */
  OPT_floop_interchange = 1187,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1188,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1189, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1190,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1191, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1192,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1193,                     /* -flra-remat */
  OPT_flto = 1194,                           /* -flto */
  OPT_flto_compression_level_ = 1195,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1196, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1197,                /* -flto-partition= */
  OPT_flto_report = 1198,                    /* -flto-report */
  OPT_flto_report_wpa = 1199,                /* -flto-report-wpa */
  OPT_flto_ = 1200,                          /* -flto= */
  OPT_fltrans = 1201,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1202,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1203,             /* -fmacro-prefix-map= */
  OPT_fmain = 1204,                          /* -fmain */
  OPT_fmath_errno = 1205,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1206,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1207,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1208,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1209,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1210,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1211,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1212,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1213,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1214,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1215,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1216,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1217,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1218,                  /* -fmodule-file= */
  OPT_fmodule_private = 1219,                /* -fmodule-private */
  OPT_fmoduleinfo = 1220,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1221,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1222,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1223,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1224,                 /* -fms-extensions */
  OPT_fmudflap = 1225,                       /* -fmudflap */
  OPT_fmudflapir = 1226,                     /* -fmudflapir */
  OPT_fmudflapth = 1227,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1228,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1229,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1230,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1231,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1232,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1233,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1234,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1235,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1236,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1237,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1238,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1239,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1240,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1241,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1242,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1243,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1244,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1245,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1246,                  /* -foffload-abi= */
  OPT_foffload_ = 1247,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1248,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1249,                         /* -fonly= */
  OPT_fopenacc = 1250,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1251,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1252,                        /* -fopenmp */
  OPT_fopenmp_simd = 1253,                   /* -fopenmp-simd */
  OPT_foperator_names = 1254,                /* -foperator-names */
  OPT_fopt_info = 1255,                      /* -fopt-info */
  OPT_fopt_info_ = 1256,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1257, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1258,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1259,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1260, */          /* -foptional-diags */
  OPT_fpack_derived = 1261,                  /* -fpack-derived */
  OPT_fpack_struct = 1262,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1263,                  /* -fpack-struct= */
  OPT_fpad_source = 1264,                    /* -fpad-source */
  OPT_fpartial_inlining = 1265,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1266,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1267,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1268,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1269,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1270,                    /* -fpeel-loops */
  OPT_fpeephole = 1271,                      /* -fpeephole */
  OPT_fpeephole2 = 1272,                     /* -fpeephole2 */
  OPT_fpermissive = 1273,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1274,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1275,                           /* -fpic */
  OPT_fpie = 1276,                           /* -fpie */
  OPT_fplan9_extensions = 1277,              /* -fplan9-extensions */
  OPT_fplt = 1278,                           /* -fplt */
  OPT_fplugin_arg_ = 1279,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1280,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1281,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1282,                /* -fpostconditions */
  OPT_fpre_include_ = 1283,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1284,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1285,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1286,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1287,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1288,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1289,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1290,           /* -fprintf-return-value */
  OPT_fprofile = 1291,                       /* -fprofile */
  OPT_fprofile_abs_path = 1292,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1293,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1294,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1295,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1296,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1297,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1298,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1299,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1300,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1301,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1302,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1303,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1304,                /* -fprofile-report */
  OPT_fprofile_reproducible = 1305,          /* -fprofile-reproducible */
  OPT_fprofile_update_ = 1306,               /* -fprofile-update= */
  OPT_fprofile_use = 1307,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1308,                  /* -fprofile-use= */
  OPT_fprofile_values = 1309,                /* -fprofile-values */
  OPT_fprotect_parens = 1310,                /* -fprotect-parens */
  OPT_frandom_seed = 1311,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1312,                  /* -frandom-seed= */
  OPT_frange_check = 1313,                   /* -frange-check */
  OPT_freal_4_real_10 = 1314,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1315,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1316,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1317,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1318,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1319,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1320,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1321,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1322,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1323,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1324,               /* -frecord-marker=8 */
  OPT_frecursive = 1325,                     /* -frecursive */
  OPT_free = 1326,                           /* -free */
  OPT_freg_struct_return = 1327,             /* -freg-struct-return */
  /* OPT_fregmove = 1328, */                 /* -fregmove */
  OPT_frelease = 1329,                       /* -frelease */
  OPT_frename_registers = 1330,              /* -frename-registers */
  OPT_freorder_blocks = 1331,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1332,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1333,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1334,             /* -freorder-functions */
  OPT_frepack_arrays = 1335,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1336,          /* -freplace-objc-classes */
  OPT_frepo = 1337,                          /* -frepo */
  OPT_freport_bug = 1338,                    /* -freport-bug */
  OPT_frequire_return_statement = 1339,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1340,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1341, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1342,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1343,                   /* -fresolution= */
  OPT_frounding_math = 1344,                 /* -frounding-math */
  OPT_frtti = 1345,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1346,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1347,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1348,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1349,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1350,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1351,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1352,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1353,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1354, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1355,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1356,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1357,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1358,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1359,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1360,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1361,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1362,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1363,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1364,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1365,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1366,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1367,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1368,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1369,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1370,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1371, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1372,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1373,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1374,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1375,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1376,               /* -fsection-anchors */
  /* OPT_fsee = 1377, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1378,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1379,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1380,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1381,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1382,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1383,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1384,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1385,                   /* -fshort-enums */
  OPT_fshort_wchar = 1386,                   /* -fshort-wchar */
  OPT_fshow_column = 1387,                   /* -fshow-column */
  OPT_fshrink_wrap = 1388,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1389,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1390,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1391,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1392,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1393,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1394,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1395,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1396,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1397,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1398,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1399,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1400,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1401,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1402,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1403,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1404,                      /* -fsquangle */
  OPT_fssa_backprop = 1405,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1406,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1407,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1408,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1409, */             /* -fstack-check */
  OPT_fstack_check_ = 1410,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1411,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1412,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1413,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1414,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1415,               /* -fstack-protector */
  OPT_fstack_protector_all = 1416,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1417,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1418,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1419,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1420,                   /* -fstack-usage */
  OPT_fstats = 1421,                         /* -fstats */
  OPT_fstdarg_opt = 1422,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1423,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1424, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1425,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1426,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1427,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1428,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1429,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1430, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1431,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1432,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1433,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1434,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1435,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1436, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1437,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1438, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1439,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1440, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1441,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1442,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1443,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1444,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1445,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1446,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1447,                   /* -ftime-report */
  OPT_ftime_report_details = 1448,           /* -ftime-report-details */
  OPT_ftls_model_ = 1449,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1450,              /* -ftoplevel-reorder */
  OPT_ftracer = 1451,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1452,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1453,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1454,                   /* -ftrampolines */
  OPT_ftransition_all = 1455,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1456,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1457,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1458,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1459,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1460,              /* -ftransition=field */
  OPT_ftransition_import = 1461,             /* -ftransition=import */
  OPT_ftransition_nogc = 1462,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1463,                /* -ftransition=tls */
  OPT_ftrapping_math = 1464,                 /* -ftrapping-math */
  OPT_ftrapv = 1465,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1466,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1467,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1468,                      /* -ftree-ccp */
  OPT_ftree_ch = 1469,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1470, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1471,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1472,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1473, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1474,                   /* -ftree-cselim */
  OPT_ftree_dce = 1475,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1476,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1477,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1478,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1479,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1480, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1481,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1482,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1483, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1484,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1485,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1486, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1487,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1488,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1489,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1490,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1491,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1492,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1493,                      /* -ftree-pre */
  OPT_ftree_pta = 1494,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1495,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1496, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1497,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1498,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1499,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1500,                     /* -ftree-slsr */
  OPT_ftree_sra = 1501,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1502, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1503, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1504,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1505,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1506,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1507, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1508,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1509, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1510,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1511,         /* -funconstrained-commons */
  OPT_funderscoring = 1512,                  /* -funderscoring */
  OPT_funit_at_a_time = 1513,                /* -funit-at-a-time */
  OPT_funittest = 1514,                      /* -funittest */
  OPT_funroll_all_loops = 1515,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1516,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1517,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1518, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1519,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1520,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1521,                 /* -funsigned-char */
  OPT_funswitch_loops = 1522,                /* -funswitch-loops */
  OPT_funwind_tables = 1523,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1524,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1525,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1526,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1527,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1528,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1529,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1530,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1531,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1532,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1533,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1534,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1535, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1536,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1537,                   /* -fverbose-asm */
  /* OPT_fversion = 1538, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1539,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1540,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1541,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1542,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1543,                   /* -fvisibility= */
  OPT_fvpt = 1544,                           /* -fvpt */
  OPT_fvtable_gc = 1545,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1546,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1547,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1548,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1549,                     /* -fvtv-debug */
  OPT_fweak = 1550,                          /* -fweak */
  OPT_fweb = 1551,                           /* -fweb */
  /* OPT_fwhole_file = 1552, */              /* -fwhole-file */
  OPT_fwhole_program = 1553,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1554,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1555,             /* -fworking-directory */
  OPT_fwpa = 1556,                           /* -fwpa */
  OPT_fwpa_ = 1557,                          /* -fwpa= */
  OPT_fwrapv = 1558,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1559,                 /* -fwrapv-pointer */
  OPT_fxref = 1560,                          /* -fxref */
  /* OPT_fzee = 1561, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1562,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1563,                     /* -fzero-link */
  OPT_g = 1564,                              /* -g */
  OPT_gant = 1565,                           /* -gant */
  OPT_gas_loc_support = 1566,                /* -gas-loc-support */
  OPT_gas_locview_support = 1567,            /* -gas-locview-support */
  OPT_gcoff = 1568,                          /* -gcoff */
  OPT_gcoff1 = 1569,                         /* -gcoff1 */
  OPT_gcoff2 = 1570,                         /* -gcoff2 */
  OPT_gcoff3 = 1571,                         /* -gcoff3 */
  OPT_gcolumn_info = 1572,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1573,                 /* -gdescribe-dies */
  OPT_gdwarf = 1574,                         /* -gdwarf */
  OPT_gdwarf_ = 1575,                        /* -gdwarf- */
  OPT_gen_decls = 1576,                      /* -gen-decls */
  OPT_ggdb = 1577,                           /* -ggdb */
  OPT_ggnu_pubnames = 1578,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1579,                   /* -gimple-stats */
  OPT_ginline_points = 1580,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1581, /* -ginternal-reset-location-views */
  OPT_gnat = 1582,                           /* -gnat */
  OPT_gnatO = 1583,                          /* -gnatO */
  OPT_gno_ = 1584,                           /* -gno- */
  OPT_gno_pubnames = 1585,                   /* -gno-pubnames */
  OPT_gpubnames = 1586,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1587,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1588,                   /* -gsplit-dwarf */
  OPT_gstabs = 1589,                         /* -gstabs */
  OPT_gstabs_ = 1590,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1591,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1592,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1593,                        /* -gtoggle */
  OPT_gvariable_location_views = 1594,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1595,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1596,                           /* -gvms */
  OPT_gxcoff = 1597,                         /* -gxcoff */
  OPT_gxcoff_ = 1598,                        /* -gxcoff+ */
  OPT_gz = 1599,                             /* -gz */
  OPT_gz_ = 1600,                            /* -gz= */
  OPT_h = 1601,                              /* -h */
  OPT_help = 1602,                           /* -help */
  OPT_idirafter = 1603,                      /* -idirafter */
  OPT_imacros = 1604,                        /* -imacros */
  OPT_imultiarch = 1605,                     /* -imultiarch */
  OPT_imultilib = 1606,                      /* -imultilib */
  OPT_include = 1607,                        /* -include */
  OPT_iplugindir_ = 1608,                    /* -iplugindir= */
  OPT_iprefix = 1609,                        /* -iprefix */
  OPT_iquote = 1610,                         /* -iquote */
  OPT_isysroot = 1611,                       /* -isysroot */
  OPT_isystem = 1612,                        /* -isystem */
  OPT_iwithprefix = 1613,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1614,              /* -iwithprefixbefore */
  OPT_k8 = 1615,                             /* -k8 */
  OPT_l = 1616,                              /* -l */
  OPT_lang_asm = 1617,                       /* -lang-asm */
  OPT_list = 1618,                           /* -list */
  OPT_mabi_ = 1619,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1620,             /* -mabort-on-noreturn */
  OPT_mandroid = 1621,                       /* -mandroid */
  OPT_mapcs = 1622,                          /* -mapcs */
  OPT_mapcs_frame = 1623,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1624,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1625,              /* -mapcs-stack-check */
  OPT_march_ = 1626,                         /* -march= */
  OPT_marm = 1627,                           /* -marm */
  OPT_masm_syntax_unified = 1628,            /* -masm-syntax-unified */
  OPT_mbe32 = 1629,                          /* -mbe32 */
  OPT_mbe8 = 1630,                           /* -mbe8 */
  OPT_mbig_endian = 1631,                    /* -mbig-endian */
  OPT_mbionic = 1632,                        /* -mbionic */
  OPT_mbranch_cost_ = 1633,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1634,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1635,     /* -mcaller-super-interworking */
  OPT_mcmse = 1636,                          /* -mcmse */
  OPT_mcpu_ = 1637,                          /* -mcpu= */
  OPT_mfdpic = 1638,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1639,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1640,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1641,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1642,                  /* -mfp16-format= */
  OPT_mfpu_ = 1643,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1644,             /* -mgeneral-regs-only */
  OPT_mglibc = 1645,                         /* -mglibc */
  /* OPT_mhard_float = 1646, */              /* -mhard-float */
  OPT_mlittle_endian = 1647,                 /* -mlittle-endian */
  OPT_mlong_calls = 1648,                    /* -mlong-calls */
  OPT_mmusl = 1649,                          /* -mmusl */
  OPT_mneon_for_64bits = 1650,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1651,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1652,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1653,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1654,               /* -mprint-tune-info */
  OPT_mpure_code = 1655,                     /* -mpure-code */
  OPT_mrestrict_it = 1656,                   /* -mrestrict-it */
  OPT_msched_prolog = 1657,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1658,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1659,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1660, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1661,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1662,                         /* -mthumb */
  OPT_mthumb_interwork = 1663,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1664,                  /* -mtls-dialect= */
  OPT_mtp_ = 1665,                           /* -mtp= */
  OPT_mtpcs_frame = 1666,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1667,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1668,                         /* -mtune= */
  OPT_muclibc = 1669,                        /* -muclibc */
  OPT_munaligned_access = 1670,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1671,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1672,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1673,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1674,              /* -mword-relocations */
  OPT_n = 1675,                              /* -n */
  OPT_name_sort = 1676,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1677,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1678,              /* -no-integrated-cpp */
  OPT_no_pie = 1679,                         /* -no-pie */
  OPT_nocpp = 1680,                          /* -nocpp */
  OPT_nodefaultlibs = 1681,                  /* -nodefaultlibs */
  OPT_nolibc = 1682,                         /* -nolibc */
  OPT_nophoboslib = 1683,                    /* -nophoboslib */
  OPT_nostartfiles = 1684,                   /* -nostartfiles */
  OPT_nostdinc = 1685,                       /* -nostdinc */
  OPT_nostdinc__ = 1686,                     /* -nostdinc++ */
  OPT_nostdlib = 1687,                       /* -nostdlib */
  OPT_o = 1688,                              /* -o */
  OPT_objects = 1689,                        /* -objects */
  OPT_p = 1690,                              /* -p */
  OPT_pass_exit_codes = 1691,                /* -pass-exit-codes */
  /* OPT_pedantic = 1692, */                 /* -pedantic */
  OPT_pedantic_errors = 1693,                /* -pedantic-errors */
  OPT_pg = 1694,                             /* -pg */
  OPT_pie = 1695,                            /* -pie */
  OPT_pipe = 1696,                           /* -pipe */
  OPT_posix = 1697,                          /* -posix */
  OPT_print_file_name_ = 1698,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1699,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1700,          /* -print-multi-directory */
  OPT_print_multi_lib = 1701,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1702,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1703,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1704,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1705,               /* -print-prog-name= */
  OPT_print_search_dirs = 1706,              /* -print-search-dirs */
  OPT_print_sysroot = 1707,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1708,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1709,                    /* -print-value */
  OPT_profile = 1710,                        /* -profile */
  OPT_pthread = 1711,                        /* -pthread */
  OPT_quiet = 1712,                          /* -quiet */
  OPT_r = 1713,                              /* -r */
  OPT_rdynamic = 1714,                       /* -rdynamic */
  OPT_remap = 1715,                          /* -remap */
  OPT_reverse_sort = 1716,                   /* -reverse-sort */
  OPT_s = 1717,                              /* -s */
  OPT_save_temps = 1718,                     /* -save-temps */
  OPT_save_temps_ = 1719,                    /* -save-temps= */
  OPT_shared = 1720,                         /* -shared */
  OPT_shared_libgcc = 1721,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1722,               /* -shared-libphobos */
  OPT_size_sort = 1723,                      /* -size-sort */
  /* OPT_specs = 1724, */                    /* -specs */
  OPT_specs_ = 1725,                         /* -specs= */
  OPT_static = 1726,                         /* -static */
  OPT_static_libasan = 1727,                 /* -static-libasan */
  OPT_static_libgcc = 1728,                  /* -static-libgcc */
  OPT_static_libgfortran = 1729,             /* -static-libgfortran */
  OPT_static_libgo = 1730,                   /* -static-libgo */
  OPT_static_liblsan = 1731,                 /* -static-liblsan */
  OPT_static_libmpx = 1732,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1733,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1734,               /* -static-libphobos */
  OPT_static_libstdc__ = 1735,               /* -static-libstdc++ */
  OPT_static_libtsan = 1736,                 /* -static-libtsan */
  OPT_static_libubsan = 1737,                /* -static-libubsan */
  OPT_static_pie = 1738,                     /* -static-pie */
  /* OPT_std_c__03 = 1739, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1740, */                /* -std=c++0x */
  OPT_std_c__11 = 1741,                      /* -std=c++11 */
  OPT_std_c__14 = 1742,                      /* -std=c++14 */
  OPT_std_c__17 = 1743,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1744, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1745, */                /* -std=c++1z */
  OPT_std_c__20 = 1746,                      /* -std=c++20 */
  /* OPT_std_c__2a = 1747, */                /* -std=c++2a */
  OPT_std_c__98 = 1748,                      /* -std=c++98 */
  OPT_std_c11 = 1749,                        /* -std=c11 */
  OPT_std_c17 = 1750,                        /* -std=c17 */
  /* OPT_std_c18 = 1751, */                  /* -std=c18 */
  /* OPT_std_c1x = 1752, */                  /* -std=c1x */
  OPT_std_c2x = 1753,                        /* -std=c2x */
  /* OPT_std_c89 = 1754, */                  /* -std=c89 */
  OPT_std_c90 = 1755,                        /* -std=c90 */
  OPT_std_c99 = 1756,                        /* -std=c99 */
  /* OPT_std_c9x = 1757, */                  /* -std=c9x */
  OPT_std_f2003 = 1758,                      /* -std=f2003 */
  OPT_std_f2008 = 1759,                      /* -std=f2008 */
  OPT_std_f2008ts = 1760,                    /* -std=f2008ts */
  OPT_std_f2018 = 1761,                      /* -std=f2018 */
  OPT_std_f95 = 1762,                        /* -std=f95 */
  OPT_std_gnu = 1763,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1764, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1765, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1766,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1767,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1768,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1769, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1770, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1771,                    /* -std=gnu++20 */
  /* OPT_std_gnu__2a = 1772, */              /* -std=gnu++2a */
  OPT_std_gnu__98 = 1773,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1774,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1775,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1776, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1777, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1778,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1779, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1780,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1781,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1782, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1783, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1784,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1785, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1786, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1787, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1788, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1789, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1790,                     /* -std=legacy */
  OPT_symbol_ = 1791,                        /* -symbol= */
  OPT_symbolic = 1792,                       /* -symbolic */
  OPT_t = 1793,                              /* -t */
  OPT_time = 1794,                           /* -time */
  OPT_time_ = 1795,                          /* -time= */
  OPT_tno_android_cc = 1796,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1797,                 /* -tno-android-ld */
  OPT_traditional = 1798,                    /* -traditional */
  OPT_traditional_cpp = 1799,                /* -traditional-cpp */
  OPT_tree_stats = 1800,                     /* -tree-stats */
  OPT_trigraphs = 1801,                      /* -trigraphs */
  OPT_type_stats = 1802,                     /* -type-stats */
  OPT_u = 1803,                              /* -u */
  OPT_undef = 1804,                          /* -undef */
  OPT_v = 1805,                              /* -v */
  OPT_version = 1806,                        /* -version */
  OPT_w = 1807,                              /* -w */
  OPT_wrapper = 1808,                        /* -wrapper */
  OPT_x = 1809,                              /* -x */
  OPT_z = 1810,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
